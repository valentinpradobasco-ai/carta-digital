...
export interface RestaurantConfig {
  ...
  logo: string;
  /**
   * "circle" (default): logo tipo ícono/isotipo, se muestra recortado en un
   * círculo (funciona bien con logos cuadrados o casi cuadrados).
   * "wide": logo tipo isologo/wordmark (más ancho que alto, con texto), se
   * muestra completo sin recortar, respetando su proporción original.
   */
  logoShape?: "circle" | "wide";
  heroImage: string;
